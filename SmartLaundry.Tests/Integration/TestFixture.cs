...
namespace SmartLaundry.Tests.Integration
{
    public class TestFixture : IDisposable
    {
        ...
        protected TestFixture(string relativeTargetProjectParentDir, string envirnoment)
        {
            ...
            UserManager =
                _server.Host.Services.GetService(typeof(UserManager<ApplicationUser>)) as UserManager<ApplicationUser>;
        ...
        public async Task<(string fieldValue, string cookieValue)> ExtractAntiForgeryValues(
