...
namespace SmartLaundry.Data.Migrations
{
    ...
    [Migration("20180507091336_ChangeDormitoryIDToId")]
    partial class ChangeDormitoryIDToId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartLaundry.Models.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartLaundry.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("DormitoryManagerId");

                    b.Property<int?>("DormitoryPorterId");
                    ...
                    b.HasIndex("DormitoryManagerId")
                        .IsUnique()
                        .HasFilter("[DormitoryManagerId] IS NOT NULL");

                    b.HasIndex("DormitoryPorterId");
            ...
            modelBuilder.Entity("SmartLaundry.Models.ApplicationUser", b =>
                {
                    b.HasOne("SmartLaundry.Models.Dormitory", "DormitoryManager")
                        .WithOne("Manager")
                        .HasForeignKey("SmartLaundry.Models.ApplicationUser", "DormitoryManagerId");
